...
describe UserTimezone::TimezoneDetector do
  ...
  context "with default options" do
    ...
    describe "when given a texas/austin state/country/city" do
    ...
    describe "when given a hash instead of an object as a user" do
      it 'gives still gives the right time zone' do
        expect(detector.detect({ state: 'TX', country: 'US', city: 'Austin' })).to eq('America/Chicago')
      end
    end

    describe "when given a Ontario/Toronto country/zip" do
    ...
    describe "when given only a zip and country" do
    ...
    describe "when given only a country" do
